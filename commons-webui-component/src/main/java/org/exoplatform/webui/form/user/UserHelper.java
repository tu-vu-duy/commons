...
public class UserHelper {
  ...
  public enum FilterType {
    ...
    FIRST_NAME("firstName"), EMAIL("email"), ALL("all");
  ...
  public static OrganizationService getOrganizationService() {
    return getComponent(OrganizationService.class);
  }
  ...
  public static ListAccess<User> searchUser(UserFilter userFilter) throws Exception {
    ...
    if (!isEmpty(groupId)) {
      ...
      //
      if (isEmpty(userFilter.getKeyword())) {
        return listUsers;
      }
      //
  ...
  public static Query queryFilter(UserFilter userFilter) {
    ...
    if (!isEmpty(keyword) && userFilter.getFilterType() != null) {
      ...
      if (FilterType.USER_NAME == userFilter.getFilterType() || FilterType.ALL == userFilter.getFilterType()) {
        q.setUserName(keyword);
      }
      if (FilterType.LAST_NAME == userFilter.getFilterType() || FilterType.ALL == userFilter.getFilterType()) {
        q.setLastName(keyword);
      }
      if (FilterType.FIRST_NAME == userFilter.getFilterType() || FilterType.ALL == userFilter.getFilterType()) {
        q.setFirstName(keyword);
      }
      if (FilterType.EMAIL == userFilter.getFilterType() || FilterType.ALL == userFilter.getFilterType()) {
        q.setEmail(keyword);
      }
    }
    return q;
